...
class WordSearch:
    ...
    def search(self, word):
        ...
        return self.left_to_right_search(word) or \
                self.right_to_left_search(word) or \
                self.up_to_down_search(word) or \
                self.down_to_up_search(word) or \
                self.top_right_to_bottom_left_search(word) or \
                self.bottom_left_to_top_right_search(word) or \
                None
